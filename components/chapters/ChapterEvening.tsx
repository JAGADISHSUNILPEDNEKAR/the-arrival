...
/**
 * Chapter VI — The Evening. After the meal, the embers and the lagoon
 * remain. Editorial column anchors bottom-left over the bonfire below it.
 */
export default function ChapterEvening({}: { index: number }) {
  ...
  useWebGLContent({
    id: "chapter-06-evening",
    src: "/assets/chapter-06-evening/photo.webp",
    poster: "/assets/chapter-06-evening/photo.poster.jpg",
  ...
  return (
    <section
      ...
      id="chapter-06-evening"
      aria-label="Chapter VI — The Evening"
    >
      <div
        ref={textRef}
        className="absolute bottom-[12%] md:bottom-[14%] left-[8%] md:left-[10%] right-[8%] md:right-[10%] z-10 max-w-[34em] pointer-events-none"
      >
        <span
          ref={indexRef}
        ...
        >
          When the kitchen closes, embers stay.
        </h2>
        <p
          ref={subRef}
        ...
        >
          A bonfire by the lagoon. The moon, your last guest.
        </p>
      </div>
    </section>
  );
